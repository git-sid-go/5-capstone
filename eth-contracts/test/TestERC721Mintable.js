...
contract("TestERC721Mintable", (accounts) => {
  ...
  describe("match erc721 spec", function () {
    beforeEach(async function () {
      ...
      await this.contract.mint(account_two, 30);
      ...
      await this.contract.mint(account_three, 40);
    });
    ...
    it("should get token balance", async function () {
      ...
      assert.equal(accountThreeBalance, 10, "Incorrect account balance");
    });
    ...
    it("should return token uri", async function () {
      ...
      assert.equal(
        tokenURI,
        "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/21",
        "Incorrect token uri"
      );
    });
  ...
  describe("have ownership properties", function () {
    ...
    it("should fail when minting when address is not contract owner", async function () {
      await expectThrow(
        this.contract.mint(account_two, 20, {
          from: account_two,
        })
      );
    });

...
contract Ownable {
    ...
    // 1) a public getter function for private '_owner' variable
    function getOwner()
    public
    view
    returns(address) {
...
contract LiveSpaceERC721Token is ERC721Metadata("LiveSpaceToken", "LST", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
